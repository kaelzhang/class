describe("neuro-class", function(){
    describe("Class", function(){
        ...
        beforeEach(function(done){
            NR.use(["neuro-class@0.1.0"],function(C) {
                Class = C;
                myClass = Class({
        ...
        it('would create a pure class with tidy prototype', function(){
            expect(myClass.prototype.data.a).to.equal(1);
        });
        ...
        it('would unlink the reference to its prototype', function(){
            ...
            expect(myClass.prototype._data.a).to.equal(1);
            
            myClass.prototype._data.a = 111;
            expect(ins._data.a).to.equal(11);
        });
        ...
        it('would always maintain the prototype chain', function(){
            ...
            delete ins._data2.a;
            expect(ins._data2.a).to.equal(1);
            
            myClass.prototype._data2.a = 111;
            delete ins._data2.a;
            expect(ins._data2.a).to.equal(111);
        });
        ...
        it('could inherit from a pure constructor', function(){
            ...
            expect(c.method2()).to.equal(10);
            expect(cp.method2).to.be.undefined;
            
            expect(c.a.a).to.equal(1);
            delete c.a.a;
            expect(c.a.a).to.equal(1);
